...
plot_fig(ax, time, force_jaw, 's', 'blue', 'Loading on jaw plate', 1.0, 'black', 5, 'None')
plot_fig(ax, time, force_5, 'o', 'red', 'Strength (5 screws)', 1.0, 'black', 5, 'None')
plot_fig(ax, time, force_4, 'o', 'green', 'Strength (4 screws)', 1.0, 'black', 5, 'None')
plot_fig(ax, time, force_2, 'o', 'orange', 'Strength (2 screws)', 1.0, 'black', 5, 'None')
