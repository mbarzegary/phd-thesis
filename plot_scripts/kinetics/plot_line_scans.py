...
x_comp_rt_3h, y_comp_rt_3h = load_from_file("horizontal-RT-3.csv", ",", 1)
x_comp_rt_6h, y_comp_rt_6h = load_from_file("horizontal-RT-6.csv", ",", 1)
x_comp_rt_12h, y_comp_rt_12h = load_from_file("horizontal-RT-12.csv", ",", 1)
x_comp_37_3h, y_comp_37_3h = load_from_file("horizontal-37-3.csv", ",", 1)
x_comp_37_6h, y_comp_37_6h = load_from_file("horizontal-37-6.csv", ",", 1)
x_comp_37_12h, y_comp_37_12h = load_from_file("horizontal-37-12.csv", ",", 1)

x_comp_rt_3h = x_comp_rt_3h * 1000 - 1500
x_comp_rt_6h = x_comp_rt_6h * 1000 - 1500
x_comp_rt_12h = x_comp_rt_12h * 1000 - 1500
x_comp_37_3h = x_comp_37_3h * 1000 - 1500
x_comp_37_6h = x_comp_37_6h * 1000 - 1500
x_comp_37_12h = x_comp_37_12h * 1000 - 1500
...
plot_fig(ax[2], x_comp_rt_3h, y_comp_rt_3h, None, 'blue', 'RT-3h', 0.15, 'black', 5)
plot_fig(ax[2], x_comp_rt_6h, y_comp_rt_6h, None, 'blue', 'RT-6h', 0.4, 'black', 5)
plot_fig(ax[2], x_comp_rt_12h, y_comp_rt_12h, None, 'blue', 'RT-12h', 1.0, 'black', 5)
plot_fig(ax[2], x_comp_37_3h, y_comp_37_3h, None, 'red', r'37$^{\circ}$C-3h', 0.15, 'black', 5)
plot_fig(ax[2], x_comp_37_6h, y_comp_37_6h, None, 'red', r'37$^{\circ}$C-6h', 0.4, 'black', 5)
plot_fig(ax[2], x_comp_37_12h, y_comp_37_12h, None, 'red', r'37$^{\circ}$C-12h', 1.0, 'black', 5)
...
plt.savefig('line_scans.png', dpi=300)
plt.show()
