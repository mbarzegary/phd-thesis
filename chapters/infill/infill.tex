...
\section{Methods}
 ...
 Finally, we present two-dimensional test cases in Section \ref{Section: numerical examples}, on which biodegradation simulations were performed later in Section \ref{section:biodegradation} to investigate the change of stiffness during the degradation process.
