...
Hydrogen evolution &
  ...
  \begin{tabular}[p{0.4\textwidth}]{@{}p{0.45\textwidth}}Performed in open environment in most cases\\ Might show underestimated values of corrosion rate due to secondary \gls{ORR} and solubility of H2 in aqueous media\end{tabular} \\ \hline
