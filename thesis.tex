\documentclass[online,faculty=firw,department=wtk,phddegree=wtk]{adsphd}
%\documentclass[print,faculty=firw,department=wtk,phddegree=wtk]{adsphd}
%\documentclass[print,bleed,cropmarks,faculty=firw,department=wtk,phddegree=wtk]{adsphd}
...
\newcommand{\glossname}{List of Abbreviations and Page Numbers}
...
% Setup babel
\usepackage[dutch,english,bidi=default]{babel} % order of passed options seems to be
...
\includechapter{objective}

\part{Model Development}
\includechapter{core}
\includechapter{fluid}
\includechapter{kinetics}
\includechapter{tissue}

\part{Code Implementation and Software Development}
\includechapter{hpc}
\includechapter{biodeg}
\includechapter{bayesian}

\part{Model Applications}
\includechapter{cup}
\includechapter{infill}
\includechapter{mandible}
